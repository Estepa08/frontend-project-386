...
Упрощённый сервис бронирования времени по мотивам Cal.com. Владелец публикует свободное время и длительности встреч (15/30 минут), гость выбирает слот и записывается на звонок. Вход — выбор роли на стартовой странице без аккаунтов.
...
- Длительности встреч **15 и 30 минут** с защитой от пересечений
- Календарь со свободными датами и слотами
- Настройка рабочего графика по дням недели и включение/выключение длительностей
